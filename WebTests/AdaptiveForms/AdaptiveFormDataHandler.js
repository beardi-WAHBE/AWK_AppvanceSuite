		...
		pages: [
			{
				...
				WhichBrowserPhone:  new AdaptiveFormField("Qué navegador...Teléfono o tableta",   InputType.DROPDOWN, false,  "guideContainer-rootPanel-panel1676498978500-guidedropdownlist___widget", 
					{"Seleccione un navegador": 0, "Chrome": 1, "Edge": 2, "Firefox": 3, "Safari": 4, "Otro": 5}
				),
				WhichDeviceAPP: new AdaptiveFormField("Qué dispositivo...WAPlanfinder mobile app", InputType.CHECKBOX, false, "guideContainer-rootPanel-guideradiobutton_204___1_widget"),
...
class AdaptiveForm {
	...
	TestForm(p_bddExample) {
		...
		for (let i = 0; i < this.pages.length; i++) {
			...
			var flag_pageFirstInputAccessible = WaitForElement(firstField.jqString_Field, 500, false) && !CheckIsInteractable("ds$('#aemFormFrame').contents().find('#loadingPage h1')");
